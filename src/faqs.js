export default [ 
      ...
      },
      {
        ...
        description: '<p>Check out the amazing work these organizations are doing to help you take control of your money! <ul class="mt-3 pl-4 ml-2 list-disc"><li><a href="https://www.gabv.org/" class="underline">Global Alliance for Banking on Values</a> is a network of independent banks using finance to deliver sustainable economic, social and environmental development. Find out if your financial institution is a member <a href="https://www.gabv.org/members/">here</a>.</li><li class="mt-2"><a href="https://www.banktrack.org/banks" class="underline">BankTrack</a> is an international organization that tracks financial institutions’ involvement with companies and projects that have a negative impact on people and the plant. Follow the link to find out if your bank is involved in any ‘dodgy deals’.</li> <li class="mt-2">Search <a href="https://weaponfreefunds.org/" class="underline">Weapons Free Funds</a> to find out if you’re investing in militarism.</li><li class="mt-2"><a href="https://linktr.ee/decolonialsolidarity" class="underline">Decolonial Solidarity</a> is a Canadian organization, comprised of Indigenous and allied supporters calling on RBC to end its funding of the Coastal GasLink Pipeline on Wet’suwet’en land.</li> <li class="mt-2">Change Course’s <a href="https://changecourse.ca/our-work/banks-off-campus/" class="underline">Banks off Campus</a> campaign supports grassroots organizers on university and college campuses to get big banks off campus by focusing on student unions to divest from big banks. </li><li class="mt-2"><a href="https://www.justpeaceadvocates.ca/" class="underline">Just Peace Advocates</a> is comprised of groups in Canada that support the global Boycott Israel movement targeting Israel’s system of settler-colonialism, occupation, and apartheid towards the Palestinian people.</li></ul>'
      },
  {
    title: 'What about my mortgage/debt/lines of credit?',
    description: 'Don’t let worries about your debts or loans hold you back from making the switch. It is absolutely doable to switch your mortgage, loans, lines of credit- but it isn’t critical! Your everyday banking and investments are the money your bank counts on using to their benefit. You can open a new account at a credit union, and still continue to make payments through your bank to your mortgage, line of credit etc.',
  }
    ]